...
This feature represents the number of requests made by a user in one minute. A very high number of requests may indicate unusual activity.
...
This feature shows how many different paths or endpoints were visited during a session. A large number of unique paths may indicate scanning behavior.
